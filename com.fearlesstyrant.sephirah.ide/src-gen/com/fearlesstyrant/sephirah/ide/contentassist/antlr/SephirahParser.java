...
public class SephirahParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SephirahGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNotBooleanExpressionAccess().getGroup_0(), "rule__NotBooleanExpression__Group_0__0");
			builder.put(grammarAccess.getPrimaryBooleanExpressionAccess().getGroup_0(), "rule__PrimaryBooleanExpression__Group_0__0");
			builder.put(grammarAccess.getPrimaryBooleanExpressionAccess().getGroup_1(), "rule__PrimaryBooleanExpression__Group_1__0");
			builder.put(grammarAccess.getPrimaryBooleanExpressionAccess().getGroup_1_1(), "rule__PrimaryBooleanExpression__Group_1_1__0");
			...
			builder.put(grammarAccess.getConditionalExpressionAccess().getConditionAssignment_0_2(), "rule__ConditionalExpression__ConditionAssignment_0_2");
			builder.put(grammarAccess.getConditionalExpressionAccess().getThenBranchAssignment_0_4(), "rule__ConditionalExpression__ThenBranchAssignment_0_4");
			builder.put(grammarAccess.getConditionalExpressionAccess().getElseBranchAssignment_0_6(), "rule__ConditionalExpression__ElseBranchAssignment_0_6");
			builder.put(grammarAccess.getOrBooleanExpressionAccess().getRightAssignment_1_2(), "rule__OrBooleanExpression__RightAssignment_1_2");
			builder.put(grammarAccess.getAndBooleanExpressionAccess().getRightAssignment_1_2(), "rule__AndBooleanExpression__RightAssignment_1_2");
			builder.put(grammarAccess.getNotBooleanExpressionAccess().getConditionAssignment_0_2(), "rule__NotBooleanExpression__ConditionAssignment_0_2");
			builder.put(grammarAccess.getPrimaryBooleanExpressionAccess().getOpAssignment_1_1_1(), "rule__PrimaryBooleanExpression__OpAssignment_1_1_1");
			builder.put(grammarAccess.getPrimaryBooleanExpressionAccess().getRightAssignment_1_1_2(), "rule__PrimaryBooleanExpression__RightAssignment_1_1_2");
